...
class MidiConverter:
    ...
    def __init__(self, port, pad):
        ...
        # define buttons
        dpadUp = Button("dpad up", "pad.dpadUp()", lambda note=self.current_note: change_note(note + 12))
        dpadDown = Button("dpad down", "pad.dpadDown()", lambda note=self.current_note: change_note(note - 12))
        dpadLeft = Button("dpad left", "pad.dpadLeft()", lambda note=self.current_note: change_note(note + 1))
        dpadRight = Button("dpad right", "pad.dpadRight()", lambda note=self.current_note: change_note(note - 1))
        ...
        a = Button("a", "pad.A()", lambda note=self.current_note: change_note(note - 4))
        b = Button("b", "pad.B()", lambda note=self.current_note: change_note(note + 4))
        x = Button("x", "pad.X()", lambda note=self.current_note: change_note(note - 7))
        y = Button("y", "pad.Y()", lambda note=self.current_note: change_note(note + 7))
